...
import com.bx_cha.mhl.dao.BillDAO;
import com.bx_cha.mhl.dao.MultiTableDAO;
import com.bx_cha.mhl.domain.Bill;
import com.bx_cha.mhl.domain.MultiTableBean;
...
public class BillService {
    ...
    public boolean orderMenu(int menuId, int nums, int diningTableId) {
        ...
        //id,billId,menuId,nums,money,diningTableId,billData,state;
        String sql = "insert into bill values (null,?,?,?,?,?,now(),'未结账');";

        // Menu getMenuById(int id) 得到一个Menu对象 .getPrice()获取单价
        // 插入sql语句当中money = 单价*数量
    ...
    public List<MultiTableBean> list2() {
        /**
         * select bill.*, menu.name, menu.price
         * from bill,menu
         * where bill.menuId = menuId;
         */
