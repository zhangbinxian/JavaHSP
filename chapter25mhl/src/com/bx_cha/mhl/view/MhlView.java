package com.bx_cha.mhl.view;

import com.bx_cha.mhl.domain.*;
import com.bx_cha.mhl.service.BillService;
import com.bx_cha.mhl.service.DiningTableService;
import com.bx_cha.mhl.service.EmployeeService;
import com.bx_cha.mhl.service.MenuService;
import com.bx_cha.mhl.utils.Utility;
        ...
        while (loop) {
            ...
            switch (key) {
                case "1":
                    ...
                    String empPasswd = Utility.readString(50);
                    Employee employee = employeeService.getEmployeeByIdAndPwd(empId, empPasswd);
                    // TODO: 2023/10/12 此处连接数据库验证user，passwd
